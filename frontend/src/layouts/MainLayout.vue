...
<template>
  <div class="relative flex h-screen overflow-hidden bg-gradient-to-br from-[#F8FBFD] via-[#EEF7FA] to-[#DFF3F8]">
    <!-- SIDEBAR DESKTOP -->
    ...
    <div class="flex min-w-0 flex-1 flex-col overflow-hidden">
      ...
      <main class="min-h-0 flex-1 overflow-x-hidden overflow-y-auto p-2 md:p-4 lg:p-5">
